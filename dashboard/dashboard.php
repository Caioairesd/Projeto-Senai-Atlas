                ...
                <nav class="sidebar">
                    ...
                    <ul class="menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="../cruds/visualizar/visualizar_cliente.php">
                                        <i class="fas fa-users"></i>
                                        <span>Visualizar Cliente</span>
                                    </a></li>
                                <li><a href="../cruds/visualizar/visualizar_fornecedor.php">
                                        <i class="fas fa-industry"></i>
                                        <span>Visualizar Fornecedor</span>
                                    </a></li>
                                <li><a href="../cruds/visualizar/visualizar_funcionario.php">
                                        <i class="fas fa-id-badge"></i>
                                        <span>Visualizar Funcionário</span>
                                    </a></li>
                                <li><a href="../cruds/visualizar/visualizar_produto.php">
