...
DELIMITER / / CREATE TRIGGER trg_entrada_estoque AFTER INSERT ON estoque FOR EACH ROW BEGIN
UPDATE produto
SET
...
END / / CREATE TRIGGER trg_saida_estoque AFTER INSERT ON item_pedido FOR EACH ROW BEGIN
UPDATE produto
SET
...
END / / CREATE TRIGGER trg_valida_estoque BEFORE INSERT ON item_pedido FOR EACH ROW BEGIN DECLARE estoque_atual INT;
