...
<head>
    ...
    <link rel="stylesheet" href="../Cruds/assets/style.css"o de alternância de tema -->
    <label class="switch">
    ...
    <div class="card-container">
        <div class="container">
            ...
            <form action="processa_login.php" method="post" class="log-card" aria-labelas</p>
                class="para">Faça login para continuar gerenciando o estoque da empresa</p>
